...
export type AppActions = {
  ...
  deleteAsset: (assetId: string, options?: { force?: boolean }) => Promise<void>;
  searchAssets: (params: AssetSearchParams) => Promise<AssetSearchResponse>;
  getAssetReferences: (assetId: string) => Promise<{ references: AssetReference[]; total: number; canDelete: boolean }>;
