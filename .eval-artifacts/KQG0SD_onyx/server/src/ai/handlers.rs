...
pub async fn ai_chat(
    ...
    // 预算检查
    crate::billing::budget::handlers::check_budget_before_ai_call(&state.db, &user_id.0, "chat").await?;
...
pub async fn ai_chat_stream(
    ...
    // 预算检查
    crate::billing::budget::handlers::check_budget_before_ai_call(&state.db, &user_id.0, "stream").await?;
