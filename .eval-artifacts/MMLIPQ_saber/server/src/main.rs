...
async fn main() {
    ...
    let protected_routes = Router::new()
        ...
        .route(
            ...
            get(export::handlers::preflight),
        )
        .route(
            "/api/projects/{project_id}/export",
            post(export::handlers::record_export),
        )
        .route(
            "/api/projects/{project_id}/exports",
            get(export::handlers::list_exports),
        )
        .route("/api/exports", get(export::handlers::list_my_exports))
        .route(
            "/api/exports/{id}",
            get(export::handlers::get_export),
        )
