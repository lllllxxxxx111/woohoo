...
async fn main() {
    ...
    let protected_routes = Router::new()
        ...
        .route(
            ...
            get(pipeline::handlers::get_review_queue),
        )
        .route(
            "/api/pipelines/runs/{run_id}/steps/{step_id}/review-detail",
            get(pipeline::handlers::get_step_review_detail),
        )
        .route(
            "/api/pipelines/runs/{run_id}/steps/{step_id}/review-decision",
