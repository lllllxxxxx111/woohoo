...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'budget', icon: <Wallet2 size={16} />, label: '预算控制' },
      ...
      <div className={styles.modal} onClick={(event) => event.stopPropagation()}>
        ...
        <main className={styles.content}>
          ...
          <div className={styles.scrollArea}>
            ...
            {activeTab === 'budget' && (
              <Space direction="vertical" size="large" style={{ width: '100%' }}>
                <Card bordered={false} title="关于预算控制" className={styles.sectionCard}>
                  <Text type="secondary">
                    设置日/月预算上限，在消耗达到预警阈值时提示，超预算后自动拦截高成本 AI 任务（图片、视频、长文本生成等），防止积分意外消耗。
                  </Text>
                </Card>
                <BudgetPanel />
              </Space>
