...
async fn main() {
    ...
    let protected_routes = Router::new()
        ...
        .route(
            "/api/budget/status",
            get(budget::handlers::get_budget_status),
        )
        .route(
            "/api/budget/settings",
            get(budget::handlers::get_budget_settings)
                .put(budget::handlers::update_budget_settings),
        )
        .route(
            "/api/budget/blocks",
            get(budget::handlers::list_block_events),
        )
