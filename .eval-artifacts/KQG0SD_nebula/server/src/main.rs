...
async fn main() {
    ...
    let protected_routes = Router::new()
        ...
        .route(
            "/api/billing/budget",
            get(billing::budget_handlers::get_budget)
                .put(billing::budget_handlers::update_budget),
        )
        .route(
            "/api/billing/budget/events",
            get(billing::budget_handlers::list_budget_events),
        )
