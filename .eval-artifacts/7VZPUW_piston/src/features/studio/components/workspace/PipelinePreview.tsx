...
type PreviewView = 'timeline' | 'review';

export const PipelinePreview: React.FC = () => {
  const [activeView, setActiveView] = useState<PreviewView>('timeline');
      ...
      <div className={styles.header}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div className={styles.viewToggle}>
            ...
            <button
              className={`${styles.viewBtn} ${activeView === 'review' ? styles.viewBtnActive : ''}`}
