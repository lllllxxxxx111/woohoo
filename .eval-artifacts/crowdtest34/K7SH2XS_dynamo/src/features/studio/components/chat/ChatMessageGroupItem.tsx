            ...
            {hasExecutionMeta && (
              <div className={styles.executionMetaPanel}>
                <div className={styles.executionTagRow}>
                  ...
                  {meta?.routingWasFallback && (
                    <Tag size="small" color="orange" title={meta.routingFallbackReason ?? undefined}>
                      路由降级{typeof meta.routingAttemptCount === 'number' && meta.routingAttemptCount > 1
                        ? ` (${meta.routingAttemptCount}次尝试)`
                        : ''}
                    </Tag>
                  )}
                  {outputKindLabel && (
