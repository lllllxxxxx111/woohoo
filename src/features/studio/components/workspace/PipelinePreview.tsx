...
import { Clock, CheckCircle, Layers, XCircle, Loader2, WifiOff } from 'lucide-react';
...
export const PipelinePreview: React.FC = () => {
  const { activeState, switchTab, aiTasks: tasks, isSseConnected: isConnected, sseError } =
    useAppStore(
      useShallow((state) => ({
